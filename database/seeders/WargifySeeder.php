...
class WargifySeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('iuran_categories')->insert([
            [
                'category_id' => $catKeamananId, 'name' => 'Iuran Keamanan', 'type' => 'MONTHLY', 'default_amount' => 30000.00, 'created_at' => now(), 'updated_at' => now()
            ],
            [
                'category_id' => $catKebersihanId, 'name' => 'Iuran Kebersihan', 'type' => 'MONTHLY', 'default_amount' => 20000.00, 'created_at' => now(), 'updated_at' => now()
            ]
        ]);
